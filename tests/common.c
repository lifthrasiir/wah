...
static const token_entry_t token_table[] = {
    ...
    TOKEN("br_on_cast._._", 0xfb, 0x18, 0x00),
    TOKEN("br_on_cast.null._", 0xfb, 0x18, 0x01),
    TOKEN("br_on_cast._.null", 0xfb, 0x18, 0x02),
    TOKEN("br_on_cast.null.null", 0xfb, 0x18, 0x03),
    TOKEN("br_on_cast_fail", 0xfb, 0x19),
    TOKEN("br_on_cast_fail._._", 0xfb, 0x19, 0x00),
    TOKEN("br_on_cast_fail.null._", 0xfb, 0x19, 0x01),
    TOKEN("br_on_cast_fail._.null", 0xfb, 0x19, 0x02),
    TOKEN("br_on_cast_fail.null.null", 0xfb, 0x19, 0x03),
    ...
    TOKEN("v128.store8_lane", 0xfd, 0x58),
    TOKEN("v128.store16_lane", 0xfd, 0x59),
    TOKEN("v128.store32_lane", 0xfd, 0x5a),
    TOKEN("v128.store64_lane", 0xfd, 0x5b),
    ...
    TOKEN("f32x4.floor", 0xfd, 0x68),
    TOKEN("f32x4.trunc", 0xfd, 0x69),
    TOKEN("f32x4.nearest", 0xfd, 0x6a),
    TOKEN("f64x2.ceil", 0xfd, 0x74),
    TOKEN("f64x2.floor", 0xfd, 0x75),
    TOKEN("f64x2.trunc", 0xfd, 0x7a),
    TOKEN("f64x2.nearest", 0xfd, 0x94, 0x01),
    TOKEN("i8x16.all_true", 0xfd, 0x63),
    TOKEN("i8x16.shl", 0xfd, 0x6b),
    TOKEN("i8x16.shr_s", 0xfd, 0x6c),
    TOKEN("i8x16.shr_u", 0xfd, 0x6d),
    ...
    TOKEN("f32x4.neg", 0xfd, 0xe1, 0x01),
    TOKEN("f32x4.sqrt", 0xfd, 0xe3, 0x01),
    TOKEN("f32x4.add", 0xfd, 0xe4, 0x01),
    TOKEN("f32x4.sub", 0xfd, 0xe5, 0x01),
    TOKEN("f32x4.mul", 0xfd, 0xe6, 0x01),
    TOKEN("f32x4.div", 0xfd, 0xe7, 0x01),
    TOKEN("f32x4.min", 0xfd, 0xe8, 0x01),
    TOKEN("f32x4.max", 0xfd, 0xe9, 0x01),
    TOKEN("f32x4.pmin", 0xfd, 0xea, 0x01),
    TOKEN("f32x4.pmax", 0xfd, 0xeb, 0x01),
    TOKEN("f64x2.abs", 0xfd, 0xec, 0x01),
    TOKEN("f64x2.neg", 0xfd, 0xed, 0x01),
    TOKEN("f64x2.sqrt", 0xfd, 0xef, 0x01),
    TOKEN("f64x2.add", 0xfd, 0xf0, 0x01),
    TOKEN("f64x2.sub", 0xfd, 0xf1, 0x01),
    TOKEN("f64x2.mul", 0xfd, 0xf2, 0x01),
    TOKEN("f64x2.div", 0xfd, 0xf3, 0x01),
    TOKEN("f64x2.min", 0xfd, 0xf4, 0x01),
    TOKEN("f64x2.max", 0xfd, 0xf5, 0x01),
    TOKEN("f64x2.pmin", 0xfd, 0xf6, 0x01),
    TOKEN("f64x2.pmax", 0xfd, 0xf7, 0x01),
    ...
    TOKEN("f64x2.relaxed_nmadd", 0xfd, 0x88, 0x02),
    TOKEN("i8x16.relaxed_laneselect", 0xfd, 0x89, 0x02),
    TOKEN("f32x4.relaxed_min", 0xfd, 0x8d, 0x02),
    TOKEN("f32x4.relaxed_max", 0xfd, 0x8e, 0x02),
    TOKEN("f64x2.relaxed_min", 0xfd, 0x8f, 0x02),
    TOKEN("f64x2.relaxed_max", 0xfd, 0x90, 0x02),
    ...
    TOKEN("catch", 0x00),
    TOKEN("catch_ref", 0x01),
    TOKEN("catch_all", 0x02),
    TOKEN("catch_all_ref", 0x03),
