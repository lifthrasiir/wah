...
(assert_return
  ...
  (v128.const i64x2 0xc000_0000_0000_0000 0xc000_0000_0000_0000)
)
(assert_return
  (invoke "i64x2.mul"
    (v128.const i32x4 0x0 0x4000_0000 0x0 0x4000_0000)
...
(assert_return
  ...
  (v128.const i64x2 0xbbff_ffff_f000_0001 0xbbff_ffff_f000_0001)
)
(assert_return
  (invoke "i64x2.mul"
    (v128.const i32x4 0x0 0xc000_0000 0x0 0xc000_0000)
...
(assert_return
  ...
  (v128.const i64x2 0x7800_0000_0000_0001 0x7800_0000_0000_0001)
)
(assert_return
  (invoke "i64x2.mul"
    (v128.const i32x4 0xffff_ffff 0x7fff_ffff 0xffff_ffff 0x7fff_ffff)
...
(assert_return
  (invoke "i64x2.mul"
    (v128.const i32x4 0x0 0x8000_0000 0x0 0x8000_0000)
    (v128.const i32x4 0x0 0x2_0000 0x0 0x2_0000)
  )
  (v128.const i64x2 0x0 0x0)
)
(assert_return
...
(assert_return
  (invoke "i64x2.mul"
    (v128.const i32x4 0x0 0x8000_0000 0x0 0x8000_0000)
    (v128.const i32x4 0x0 0x2 0x0 0x2)
  )
  (v128.const i64x2 0x0 0x0)
)
(assert_return
...
(assert_return
  (invoke "i64x2.mul"
    (v128.const i32x4 0x8000_0000 0x0 0x8000_0000 0x0)
    (v128.const i32x4 0x0 0x0 0x0 0x0)
  )
  (v128.const i64x2 0x0 0x0)
)
...
(assert_return
  ...
  (v128.const i64x2 0x7ff0_0000_0000_0000 0x7ff0_0000_0000_0000)
)
(assert_return
  (invoke "i64x2.mul"
    (v128.const i32x4 0x1 0x0 0x1 0x0)
  ...
  (v128.const i64x2 0xfff0_0000_0000_0000 0xfff0_0000_0000_0000)
)
(assert_return
  (invoke "i64x2.mul"
    (v128.const i32x4 0x1 0x0 0x1 0x0)
  ...
  (v128.const i64x2 0x7ff8_0000_0000_0000 0x7ff8_0000_0000_0000)
)
(assert_return
  (invoke "i64x2.mul"
    (v128.const i32x4 0x0 0x0 0x1 0x0)
...
(assert_return
  ...
  (v128.const i64x2 0x86c2_8d12_bb50_2bb9 0x86c2_8d12_bb50_2bb9)
)
(assert_return
  (invoke "i64x2.mul"
    (v128.const i32x4 0x90ab_cdef 0x1234_5678 0x90ab_cdef 0x1234_5678)
  ...
  (v128.const i64x2 0x602f_05e9_e556_18cf 0x602f_05e9_e556_18cf)
)
(assert_return
...
(assert_invalid
  (module binary
    ...
    "\00\01\87\80\80\80\00\00\41\00\fd\c1\01\0b"
  )
  "type mismatch"
)
(assert_invalid
...
(assert_invalid
  (module binary
    ...
    "\00\01\85\80\80\80\00\00\fd\c1\01\0b"
  )
  "type mismatch"
)
(assert_invalid
  (module binary
    ...
    "\00\00\00\00\00\00\00\00\00\00\fd\ce\01\0b"
  )
  "type mismatch"
)
(assert_invalid
  (module binary
    "\00\61\73\6d\01\00\00\00\01\85\80\80\80\00\01\60"
    "\00\01\7b\03\82\80\80\80\00\01\00\0a\8b\80\80\80"
    "\00\01\85\80\80\80\00\00\fd\ce\01\0b"
  )
  "type mismatch"
)
(assert_invalid
  (module binary
    ...
    "\00\01\7b\03\82\80\80\80\00\01\00\0a\9d\80\80\80"
    "\00\01\97\80\80\80\00\00\fd\0c\00\00\00\00\00\00"
    "\00\00\00\00\00\00\00\00\00\00\fd\d1\01\0b"
  )
  "type mismatch"
)
(assert_invalid
  (module binary
    "\00\61\73\6d\01\00\00\00\01\85\80\80\80\00\01\60"
    "\00\01\7b\03\82\80\80\80\00\01\00\0a\8b\80\80\80"
    "\00\01\85\80\80\80\00\00\fd\d1\01\0b"
  )
  "type mismatch"
)
(assert_invalid
  (module binary
    ...
    "\00\01\7b\03\82\80\80\80\00\01\00\0a\9d\80\80\80"
    "\00\01\97\80\80\80\00\00\fd\0c\00\00\00\00\00\00"
    "\00\00\00\00\00\00\00\00\00\00\fd\d5\01\0b"
  )
  "type mismatch"
)
(assert_invalid
  (module binary
    "\00\61\73\6d\01\00\00\00\01\85\80\80\80\00\01\60"
    "\00\01\7b\03\82\80\80\80\00\01\00\0a\8b\80\80\80"
    "\00\01\85\80\80\80\00\00\fd\d5\01\0b"
  )
  "type mismatch"
)
(module definition binary
