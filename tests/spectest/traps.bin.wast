...
(module instance)
(assert_trap
  (invoke "no_dce.i32.div_s" (i32.const 0x1) (i32.const 0x0))
  "integer divide by zero"
)
(assert_trap
  (invoke "no_dce.i32.div_u" (i32.const 0x1) (i32.const 0x0))
  "integer divide by zero"
)
(assert_trap
  (invoke "no_dce.i64.div_s" (i64.const 0x1) (i64.const 0x0))
  "integer divide by zero"
)
(assert_trap
  (invoke "no_dce.i64.div_u" (i64.const 0x1) (i64.const 0x0))
  "integer divide by zero"
)
(assert_trap
  (invoke "no_dce.i32.div_s" (i32.const 0x8000_0000) (i32.const 0xffff_ffff))
  "integer overflow"
)
(assert_trap
...
(module instance)
(assert_trap
  (invoke "no_dce.i32.rem_s" (i32.const 0x1) (i32.const 0x0))
  "integer divide by zero"
)
(assert_trap
  (invoke "no_dce.i32.rem_u" (i32.const 0x1) (i32.const 0x0))
  "integer divide by zero"
)
(assert_trap
  (invoke "no_dce.i64.rem_s" (i64.const 0x1) (i64.const 0x0))
  "integer divide by zero"
)
(assert_trap
  (invoke "no_dce.i64.rem_u" (i64.const 0x1) (i64.const 0x0))
  "integer divide by zero"
)
(module definition binary
...
(module instance)
(assert_trap
  (invoke "no_dce.i32.trunc_f32_s" (f32.const nan:0x40_0000))
  "invalid conversion to integer"
)
(assert_trap
  (invoke "no_dce.i32.trunc_f32_u" (f32.const nan:0x40_0000))
  "invalid conversion to integer"
)
(assert_trap
  (invoke "no_dce.i32.trunc_f64_s" (f64.const nan:0x8_0000_0000_0000))
  "invalid conversion to integer"
)
(assert_trap
  (invoke "no_dce.i32.trunc_f64_u" (f64.const nan:0x8_0000_0000_0000))
  "invalid conversion to integer"
)
(assert_trap
  (invoke "no_dce.i64.trunc_f32_s" (f32.const nan:0x40_0000))
  "invalid conversion to integer"
)
(assert_trap
  (invoke "no_dce.i64.trunc_f32_u" (f32.const nan:0x40_0000))
  "invalid conversion to integer"
)
(assert_trap
  (invoke "no_dce.i64.trunc_f64_s" (f64.const nan:0x8_0000_0000_0000))
  "invalid conversion to integer"
)
(assert_trap
  (invoke "no_dce.i64.trunc_f64_u" (f64.const nan:0x8_0000_0000_0000))
  "invalid conversion to integer"
)
(module definition binary
