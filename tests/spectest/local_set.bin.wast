...
(assert_return (invoke "type-param-i32" (i32.const 0x2)))
(assert_return (invoke "type-param-i64" (i64.const 0x3)))
(assert_return (invoke "type-param-f32" (f32.const 0x1.1999_9ap+2)))
(assert_return (invoke "type-param-f64" (f64.const 0x1.6p+2)))
(assert_return (invoke "as-block-value" (i32.const 0x0)))
(assert_return (invoke "as-loop-value" (i32.const 0x0)))
(assert_return (invoke "as-br-value" (i32.const 0x0)))
(assert_return (invoke "as-br_if-value" (i32.const 0x0)))
(assert_return (invoke "as-br_if-value-cond" (i32.const 0x0)))
...
(assert_invalid
  (module binary
    ...
    "\80\00\01\04\41\00\0b\01\d2\00\0b\0a\9b\80\80\80"
    "\00\02\84\80\80\80\00\00\20\00\0b\8c\80\80\80\00"
    "\00\02\7f\21\00\41\00\11\00\00\0b\0b"
  )
  "type mismatch"
)
(assert_invalid
